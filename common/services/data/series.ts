export function getPositionInSeries(tags: {}): number | null {
...
export function getSeriesColor(seriesUrl: string): string | null {
  const lookup = {
...
export function getSeriesCommissionedLength(seriesUrl: string): number | null {
  const lookup = {
    'electric-sublime': 6,
    'the-outsiders': 6,
  };
